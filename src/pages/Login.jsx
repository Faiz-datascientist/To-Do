...
export default function Login({ onAuth, onSwitchMode }) {
  ...
  return (
    <form onSubmit={submit} style={{ width: '100%' }}>
      ...
      <div className="auth-divider"><span>Or Sign In Using</span></div>

      <div className="social-icons">
        <a href="#" className="facebook" title="Facebook">F</a>
        <a href="#" className="twitter" title="Twitter">T</a>
        <a href="#" className="google" title="Google">G</a>
      </div>

      <div className="auth-footer">
        Don't have an account?{' '}
        <a href="#" onClick={(e) => { e.preventDefault(); onSwitchMode?.('register') }}>Sign up</a>
      </div>
    </form>
  )
}
